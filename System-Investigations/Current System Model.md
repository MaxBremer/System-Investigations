...
- Each System contains a "notes" folder
	...
	- The only restriction is to keep them short.
	- Later systems will likely specify more on what individual notes should contain.
...
- Each System contains an "XXX-revisions.md" file. 
	...
	- This is an archival space for old versions of the model. When changes are being made to the model, it's a new current-model version, and BEFORE any changes are made it should be copied to the revisions file.
- Each System contains an "XXX-questions.md" file.
	- XXX is the current systems number.
	- This file contains current open questions for this system.
	- Answers, leads, follow-ups etc can be added beneath a question.
	- Once a question is answered, it should be moved to the current-model.md file.
- Each System contains an "XXX-current-model.md" file.
	...
	- When major changes are made to the model, do the following: 
		1) save the old version of the model to the revisions.md file 
